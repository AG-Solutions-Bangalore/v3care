...
import { BASE_URL, CLIENTS_IMAGE } from "../../../base/BaseUrl";
...
const ClientsEditMaster = () => {
    ...
    const fetchClient = async () => {
      try {
        ...
        const response = await axios.get(
          `${BASE_URL}/api/panel-fetch-client-by-id/${id}`,
          {
            headers: {
  ...
  const handleStatusChange = (e) => {
    setClients({
      ...clients,
      client_status: e.target.checked ? "Active" : "Inactive",
    });
  };
  ...
  const onSubmit = (e) => {
    ...
    data.append("client_status", clients.client_status);
    ...
    if (form.checkValidity()) {
      ...
      axios({
        url: `${BASE_URL}/api/panel-update-client/${id}?_method=PUT`,
        method: "POST",
        data,
        headers: {
        ...
        .then((res) => {
          if (res.data.code == "200") {
            toast.success(res.data?.msg || "Client updated successfully");
            navigate(`/clients?page=${pageNo}`);
          } else {
            toast.error(res.data?.msg || "Error updating client");
          }
        })
        .catch((error) => {
  ...
  return (
    <Layout>
      ...
      <div className="textfields-wrapper">
        <PageHeader title={"Edit Client"} onClick={handleBack} />
              ...
              <div>
                <div className="space-y-6">
                  ...
                  {/* <div className="flex items-center">
                    ...
                    <Switch
                      checked={clients.client_status === "Active"}
                      onChange={handleStatusChange}
                      color="primary"
                      inputProps={{ "aria-label": "client status toggle" }}
                    />
                    <span
  ...
  {imagePreview ? (
    <div className="flex flex-col items-center">
      ...
      {clients.client_status === "Inactive" && (
...
export default ClientsEditMaster;