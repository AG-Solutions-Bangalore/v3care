...
import { BASE_URL, NO_IMAGE_URL, RIGHTSIDEBAR_IMAGE } from "../../../base/BaseUrl";
...
const EditRightSidebar = () => {
  ...
  const handleStatusChange = (e) => {
    setFormData((prev) => ({
      ...prev,
      serviceDetails_status: e.target.value,
    }));
  };
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    {initialImage ? "Upload a new image to replace the existing one" : "Upload an image for this service (JPEG, PNG, etc.)"}
                  </p>
                </div>
                ...
                <div>
                  <FormControl fullWidth>
                    ...
                    <MuiSelect
                      ...
                      id="serviceDetails_status"
                      name="serviceDetails_status"
                      value={formData.serviceDetails_status}
